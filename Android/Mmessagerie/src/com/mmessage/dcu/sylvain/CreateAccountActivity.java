...
public class CreateAccountActivity extends Activity implements OnTaskCompleted {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_messageUser = (TextView) _layout
				.findViewById(R.id.createAccountTextMessage);
		...
		_createAccount = (Button) _layout
				.findViewById(R.id.createAccountSubmit);
		...
		_createAccount.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				_services.createNewUser(_userName.getText().toString(),
						_password.getText().toString(), _email.getText()
								.toString());
			}
		});
	...
	public void onTaskCompleted(Object parObject) {
		...
		if (locIsAccountCreated) {
			...
			Toast.makeText(getBaseContext(), locToDisplay, Toast.LENGTH_SHORT)
					.show();
			...
			_messageUser
					.setText("Impossible to create your account, please try with "
