...
public class CreateAccountController implements OnTaskCompleted {
	...
	public void createNewUser(String parUserName, String parPassword,
			String parEmailAddress) {
		...
		new PostRESTTask(this, false, Commands.CREATE_A_USER, locNameValuePairs)
